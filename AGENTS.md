# Culture, Art and Sports Pupil’s Book Standard Two — ADT Bundle Reference
...
**Culture, Art and Sports Pupil’s Book Standard Two** — This English-language pupil’s book from the Tanzania Institute of Education is a Standard Two primary textbook, roughly for early elementary learners in Tanzania. It introduces children to Tanzanian culture, religious tolerance and ethics, simple visual and performing arts, and basic sports and games through short explanations, pictures, questions, and practical activities. The book emphasizes competency-based learning, community awareness, creativity, respect for diversity, and active participation, reflecting a hands-on primary curriculum from Tanzania.
...
```
CULTURE-BOOK-TWO-FINAL-LATEST-CONFERENECE-4-AUGUST-MANYAMA/
├── adt/                              # THE WEB APP
...
├── CULTURE-BOOK-TWO-FINAL-LATEST-CONFERENECE-4-AUGUST-MANYAMA.db                    # SQLite database (pipeline state)
├── CULTURE-BOOK-TWO-FINAL-LATEST-CONFERENECE-4-AUGUST-MANYAMA.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg003_im001": "Blue title box with the words Table of contents.",
  "gl001": "accompanied",
  "gl001_def": "happening together with something else",
  "qz001_que": "Which traditional house has a flat roof covered with grass and mud?",
  "qz001_o0": "1) Banda house",
  "qz001_o0_exp": "❌ Not quite. A banda house has a two-sided roof, not a flat roof."
}
```
...
```json
{
  "accompanied": {
    "word": "accompanied",
    "definition": "happening together with something else",
    "variations": ["accompany","accompanies","accompanied","accompanying"],
    "emoji": "🎶🤝"
  }
}
```
...
```json
{
  "title": "Culture, Art and Sports Pupil’s Book Standard Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which traditional house has a flat roof covered with grass and mud?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. A banda house has a two-sided roof, not a flat roof." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Banda house</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `CULTURE-BOOK-TWO-FINAL-LATEST-CONFERENECE-4-AUGUST-MANYAMA.pdf` |
| Pipeline database | `CULTURE-BOOK-TWO-FINAL-LATEST-CONFERENECE-4-AUGUST-MANYAMA.db` (SQLite) |

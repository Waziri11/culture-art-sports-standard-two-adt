#!/usr/bin/env python3
"""Regenerate the combined Activity 2 heading narration."""
...
TEXT_IDS = ("pg011_n0014", "pg011_n0014_easy_read")


def main() -> None:
    texts = json.loads((I18N / "texts.json").read_text(encoding="utf-8"))
    output = I18N / "audio"
    with tempfile.TemporaryDirectory(prefix="adt-activity2-audio-") as temp:
        temp_dir = Path(temp)
    ...
    print("Generated combined Activity 2 standard and easy-read narration")

#!/usr/bin/env python3
"""Regenerate page 43 question narration without speaking answer-line markup."""
...
IDS = ("pg026_n0023", "pg026_n0025", "pg026_n0023_easy_read", "pg026_n0025_easy_read")
...
def main() -> None:
    ...
    clips = []
    with tempfile.TemporaryDirectory(prefix="adt-page43-blanks-") as temp:
        temp_dir = Path(temp)
        for text_id in IDS:
    ...
    (ROOT / "page43-blank-audio-report.json").write_text(json.dumps({
        "voice": "Tessa", "speakingRateWordsPerMinute": 145, "clips": clips,
    }, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print("Generated 4 page 43 question clips without placeholder speech")
